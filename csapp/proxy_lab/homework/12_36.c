...
int main(int argc, char **argv)
{
    ...
    while (1)
    {
        pool.ready_set = pool.read_set;                                          // line:conc:echoservers:beginreadyset
        pool.nready = Select(pool.maxfd + 1, &pool.ready_set, NULL, NULL, NULL); // line:conc:echoservers:endreadyset
