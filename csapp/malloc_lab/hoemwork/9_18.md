...
// use Hearder's last two bits to store prev_alloc
...
#define GET_PREV_ALLOC(p) ((GET(p) >> 1) & 0x1)               //line:vm:mm:getprevalloc
...
void *mm_malloc(size_t size) 
{
    ...
    // because allocated block don't need to store footer
    // so 2DSIZE can store 2~3 WSIZE
