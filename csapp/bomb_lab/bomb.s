...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) # the first number must be 1, or jump to explode_bomb
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax # get the number which last input
  400f1a:	01 c0                	add    %eax,%eax # double it
  400f1c:	39 03                	cmp    %eax,(%rbx) # compare it with the current number
  400f1e:	74 05                	je     400f25 <phase_2+0x29> # if equal, jump to next number
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx # next number
  400f29:	48 39 eb             	cmp    %rbp,%rbx # compare the current number with the last number
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> # if all numbers are correct, jump to the end
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # 4th ?
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # 3rd ?
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi # 2nd %d %d
  ...
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # 1st greater than 7, jump to explode_bomb
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) # may be a external array
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax # edx = 0xe
  400fd4:	29 f0                	sub    %esi,%eax # eax = 0xe - 0x0
  400fd6:	89 c1                	mov    %eax,%ecx # ecx = 0xe
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx # ecx = ecx >> 0x1f = 0
  400fdb:	01 c8                	add    %ecx,%eax # eax = 0xe
  400fdd:	d1 f8                	sar    %eax # eax = eax >> 1 = 0x7
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx = 1 * rsi + rax = 0x0 + 0x7 = 0x7
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax  # compare the number of input
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) # compare the first input vs 0xe
  401033:	76 05                	jbe    40103a <phase_4+0x2e> # if less than or equal to 0xe, jump to 40103a
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx # third arg
  40103f:	be 00 00 00 00       	mov    $0x0,%esi # second arg
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi # first arg
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax # if eax is 0, jump to 401058
...
00000000004010f4 <phase_6>:
  ...
  401121:	76 05                	jbe    401128 <phase_6+0x34> # the first integer is in range [1,6]
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax # move with sign-extension from doubleword to quadword
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) # compare the first integer with the next one
  ...
  401151:	eb c1                	jmp    401114 <phase_6+0x20> # each integer is in range [1,6] and no duplicates
  ...
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> # int[i] = 7 - int[i]
  ...
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # rdx -> rsp[0x20 + 2*rsi]
  ...
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx # %rbx the origin node
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax # %rax the next node
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx # change the secquence of linked list
  ...
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax # %rax the next node
  4011e3:	8b 00                	mov    (%rax),%eax 
  4011e5:	39 03                	cmp    %eax,(%rbx) # %rbx is the origin node
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi # rdi = 0x6030f0 *0x6030f0 = 36
  40120b:	74 2b                	je     401238 <fun7+0x34> # if Null, return 0
  40120d:	8b 17                	mov    (%rdi),%edx
  40120f:	39 f2                	cmp    %esi,%edx
  401211:	7e 0d                	jle    401220 <fun7+0x1c> # <= 
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi # left
  ...
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi # right
  40122d:	e8 d2 ff ff ff       	call   401204 <fun7>
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax # 2*%rax+1
...
0000000000401242 <secret_phase>:
  ...
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax # < 1000
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	call   40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi
  401273:	e8 8c ff ff ff       	call   401204 <fun7> # func7 accept two args
  401278:	83 f8 02             	cmp    $0x2,%eax # return 2
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp # 24
  401460:	48 89 f2             	mov    %rsi,%rdx # 3rd
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx # 4th
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) # 8th
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax # ofsset 16
  401474:	48 89 04 24          	mov    %rax,(%rsp) # 7th
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9 # 6th
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8 # 5th
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi # 2nd # print (char*)0x4025c3 
